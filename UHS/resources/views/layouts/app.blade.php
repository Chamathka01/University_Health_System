...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .user-info .name { color: white; font-size: 12.5px; font-weight: 500; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .user-info .role { color: var(--sidebar-text); font-size: 11px; text-transform: capitalize; }

        .sidebar-user a.logout { color: var(--sidebar-text); font-size: 14px; }
        .sidebar-user a.logout:hover { color: #f87171; }
        ...
        .badge-status.prescription-ready { background: #ede9fe; color: #5b21b6; }
        .badge-status.completed      { background: #dcfce7; color: #166534; }
        .badge-status.student        { background: #e0f2fe; color: #0c4a6e; }
        .badge-status.staff          { background: #fce7f3; color: #831843; }
        ...
        .btn-success { background: var(--success); border-color: var(--success); border-radius: 8px; font-size: 13.5px; }
