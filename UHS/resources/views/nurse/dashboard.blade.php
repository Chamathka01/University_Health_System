...
<div class="page-header">
    <div>
        ...
        <div class="breadcrumb-text">Scan or search patients · manage prescriptions</div>
    </div>
        ...
        <div class="col-md-5">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fa-solid fa-camera" style="color:#1a6fc4;"></i> Camera Scan
                </div>
                <div class="card-body text-center">
                    ...
                    <button class="btn btn-outline-secondary btn-sm mt-3 ms-2 px-3"
                            onclick="stopScanner()"
                            id="stopBtn"
                            style="display:none;">
                        Stop
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <label class="form-label">Enter Reg No or Staff ID</label>
                    ...
                    <div id="patientBox" style="display:none; margin-top:14px;">
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>
                        <i class="fa-solid fa-prescription-bottle-medical" style="color:#1a6fc4;"></i>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge-status {{ $visit->patient->role }}">
                                            {{ ucfirst($visit->patient->role) }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="/nurse/complete/{{ $visit->id }}"
                                           class="btn btn-success btn-sm">
                                            <i class="fa-solid fa-pills me-1"></i> Give Medicine
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
...
">
    ...
    ">
        ...
        <table style="width:100%; font-size:13.5px;">
            <tr>
                <td style="color:#64748b; padding:6px 0; width:110px;">Patient ID</td>
                <td>
                    <code id="m_id" style="background:#f1f5f9; padding:2px 7px; border-radius:5px;"></code>
                </td>
            </tr>
            <tr>
                <td style="color:#64748b; padding:6px 0; vertical-align:top;">Diagnosis</td>
                <td id="m_diag" style="white-space:pre-wrap;"></td>
            </tr>
            <tr>
                <td style="color:#64748b; padding:6px 0; vertical-align:top;">Prescription</td>
                <td id="m_pres" style="white-space:pre-wrap;"></td>
            </tr>
            <tr>
                <td style="color:#64748b; padding:6px 0; vertical-align:top;">Notes</td>
                <td id="m_notes" style="white-space:pre-wrap;"></td>
            </tr>
        </table>

        <div id="m_report_wrap" style="display:none; margin-top:14px;">
            <a id="m_report_link"
               href="#"
               target="_blank"
    ...
    Html5Qrcode.getCameras().then(devices => {
        ...
        if (devices.length) {
            ...
            scanner.start(
                ...
                { fps: 10, qrbox: 250 },
                (text) => {
                    // Put scanned value into input and search
