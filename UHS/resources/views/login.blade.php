...
<div class="login-wrap">
    ...
    <div class="panel-right">
        <h4>Welcome back</h4>
        <p class="subtitle">Sign in with the Google email created by the nurse</p>
        ...
        <p class="reg-link">No password required. Contact the nurse if your email is not registered.</p>
    </div>
</div>
</body>
</html>
